...
Connects Claude to Octopus AI's Leo — a conversational connection plus a set of direct, deterministic tools for data and messaging — and adds three FP&A workflows on top.
